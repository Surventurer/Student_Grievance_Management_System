...
urlpatterns = [
    ...
    path('superadmin/users/<int:user_id>/clear-failed-attempts/', superadmin_views.clear_failed_login_attempts, name='clear_failed_login_attempts'),
    path('superadmin/users/clear-failed-attempts/', superadmin_views.clear_failed_login_attempts, name='clear_all_failed_login_attempts'),
